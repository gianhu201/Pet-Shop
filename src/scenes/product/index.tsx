...
const Product: React.FC = () => {
  ...
  return (
<div className="min-h-screen bg-gradient-to-b bg-gray-20 flex items-center justify-center"> 
      ...
      {products.map((product) => (
        <div key={product.id} className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="p-6">
            ...
            <button onClick={() => addPet(product)} className="mt-4 w-full bg-blue-500 text-white font-semibold py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
          Add to Cart
        </button>
          </div>
        </div>
